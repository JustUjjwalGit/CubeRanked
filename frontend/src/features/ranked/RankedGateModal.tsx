...
export default function RankedGateModal({ onClose, onGoogle, onEmail, onRegister }: RankedGateModalProps) {
  return (
    <AnimatePresence>
      <motion.div
      ...
      >
        ...
        >
          ...
          <div className="ranked-gate-actions">
            ...
            <button type="button" className="ranked-gate-btn email" onClick={onEmail}>
              Sign in with Email
            </button>

            <button type="button" className="ranked-gate-btn register" onClick={onRegister}>
              Create Account
            </button>
          </div>
